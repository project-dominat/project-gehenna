...
namespace Content.Client.ContextMenu.UI
{
    ...
    public sealed partial class ContextMenuPopup : Popup
    {
        ...
        public ContextMenuPopup (ContextMenuUIController uiController, ContextMenuElement? parentElement) : base()
        {
            ...
            _onMenuBodyChildRemoved = OnMenuBodyChildRemoved;
            _onPopupHide = HandlePopupHide;
            ...
            MenuBody.OnChildRemoved += _onMenuBodyChildRemoved;
            ...
            OnPopupHide += _onPopupHide;
        }

        private void OnMenuBodyChildRemoved(Control control)
        {
            if (_disposing)
                return;

            _uiController.OnRemoveElement(this, control);
        }

        private void HandlePopupHide()
        {
            if (_disposing || ParentElement == null)
                return;
        ...
        protected override void Dispose(bool disposing)
        {
            if (disposing)
            {
                ...
                if (ParentElement is { Disposed: false } parentElement &&
                    parentElement.SubMenu == this)
                {
                    parentElement.SubMenu = null;
                }
