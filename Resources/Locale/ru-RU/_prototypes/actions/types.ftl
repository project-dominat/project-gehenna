...
ent-ActionJumpBoost = Усиленный прыжок

ent-ActionShootWater = Брызнуть водой!
    .desc = Брызгает водой в сторону ваших врагов.

ent-ActionVulpkaninGravityJump = Прыжок
    .desc = Используйте свои ловкие ноги, чтобы прыгнуть на короткое расстояние. Смотрите, не врежьтесь ни во что!
