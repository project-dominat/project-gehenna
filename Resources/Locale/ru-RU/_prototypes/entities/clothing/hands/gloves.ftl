ent-ClothingHandsGlovesBoxingBase = боксёрские перчатки
    .desc = Перчатки для соревновательного бокса.
...
ent-ClothingHandsKnuckleDustersSyndicate = синдикастет
...
ent-GlovesBoxingRiggedRandomSpawner = спавнер случайной подстроенной боксёрской перчатки
