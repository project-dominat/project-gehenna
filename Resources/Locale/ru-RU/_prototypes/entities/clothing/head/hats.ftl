...
ent-ClothingHeadHatFedoraPress = федора прессы
    .desc = На ленте приклеена маленькая записка с надписью "PRESS". Практически пропуск всюду!

ent-ClothingHeadHatMitreClown = митра Хонкоматери
    .desc = Прихожанам трудно заметить банановую кожуру на полу, когда они смотрят на ваш славный головной убор.
