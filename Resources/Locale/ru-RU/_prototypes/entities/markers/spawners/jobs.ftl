...
ent-SpawnPointAnyJob = любая профессия
    .desc = { ent-SpawnPointJobBase.desc }
...
ent-SpawnPointERTLeader = ОБР лидер
    .desc = { ent-SpawnPointJobBase.desc }

ent-SpawnPointERTChaplain = ОБР священник
    .desc = { ent-SpawnPointJobBase.desc }

ent-SpawnPointERTEngineer = ОБР инженер
    .desc = { ent-SpawnPointJobBase.desc }

ent-SpawnPointERTMedical = ОБР медик
    .desc = { ent-SpawnPointJobBase.desc }

ent-SpawnPointERTSecurity = ОБР офицер безопасности
    .desc = { ent-SpawnPointJobBase.desc }

ent-SpawnPointERTJanitor = ОБР уборщик
    .desc = { ent-SpawnPointJobBase.desc }
