...
ent-FoodDonkpocketMoth = мотыльковый донк-пакет
    .desc = Жужжащая версия донк-карманчика, созданная во время массовых протестов против... Да кому это интересно? Просто донк-карманчики для мотыльков.

ent-FoodDonkpocketMothWarm = теплый мотыльковый донк-пакет
