...
ent-FoodBoxCloth = коробка ткани FlutterSoft
    .desc = Клетчатка — важнейшая часть рациона моли! Не пропускайте её и не довольствуйтесь хламом со дна шкафчика, покупайте качественную ткань бренда FlutterSoft.
