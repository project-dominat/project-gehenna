...
ent-PinpointerMothershipPiece = фрагмент пинпоинтера ядра
    .desc = Фрагмент пинпоинтера ядра. Чтобы починить его, нужно четыре таких.

ent-PinpointerMothershipRepaired = починенный пинпоинтер ядра
    .desc = Портативное устройство слежения, указывающее направление к ядру материнского корабля. Этот экземпляр повидал лучшие дни.
