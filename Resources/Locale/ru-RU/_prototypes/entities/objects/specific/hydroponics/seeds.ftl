...
ent-MeatwheatSeeds = пакет семян (мясопшеница)
...
ent-TeaPlantSeeds = пакет семян (чайное растение)
    .desc = { ent-SeedBase.desc }
...
ent-WorldPeaSeeds = пакет семян (мировой горох)
...
ent-RealCapfruitSeeds = пакет семян (капфрут)
