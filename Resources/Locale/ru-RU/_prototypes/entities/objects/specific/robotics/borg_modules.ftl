...
ent-BorgModuleAdvancedTopical = продвинутый медицинский модуль киборга
    .desc = Продвинутый медицинский модуль, содержащий киборг-адаптацию крайне желанного гипоспрея. Теперь ваши киборги смогут ещё быстрее колоть вредителям команды хлоралгидрат!

ent-BorgModulePrying = модуль взлома
    .desc = Универсальный модуль киборга, позволяющий взламывать двери.

ent-XenoborgModuleJump = модуль прыжка ксеноборга
    .desc = Модуль, позволяющий ксеноборгу прыгать вперёд.

ent-XenoborgModuleTileGun = модуль ксеноборга с плиткомётом
    .desc = Модуль с плиткомётом. Подождите, с чем?
