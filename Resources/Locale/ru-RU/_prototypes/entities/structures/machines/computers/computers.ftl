...
ent-ComputerNukieDelivery = компьютер доставки Синдиката
    .desc = Компьютер, способный блюспейс-доставкой получать определённое снаряжение для ядерных операций. Плата интегрирована в корпус и не может быть извлечена при разборке.
