...
ent-WallIronsandCobblebrick = стена из железопесчаного кирпича
    .desc = Бледные округлые формы, составляющие эту стену, выглядят разительно иначе, чем железные пески, из которых она якобы сделана.
