...
marking-HumanHairBaby = Детка

marking-HumanHairCube = Куб

marking-HumanHairBAlt = Волосы до плеч (над глазами)

marking-HumanHairLongWithBangs = длинные с челкой

marking-HumanHairOverEyePigtail = Косичка (над глазом)
