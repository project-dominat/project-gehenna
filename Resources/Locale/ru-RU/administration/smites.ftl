...
admin-smite-crawler-name = Гусеничный

admin-smite-homing-rod-name = Самонаводящийся стержень

admin-smite-homing-rod-slow-name = Замедляющий жезл

admin-smite-silicon-laws-bound-name = Стать кремнием

## Smite descriptions

admin-smite-kill-sign-hidden-description = Отмечает игрока смертью от своих товарищей. Скрыт от выбранного игрока.

admin-smite-vulpkanin-species-swap-description = Это меняет их вид на Вульпканин. Полезно для людей, которые были космическими расистами.

admin-smite-crawler-description = Заставляет цель упасть и потерять возможность встать. Также уберите им руки для дополнительного эффекта!

admin-smite-homing-rod-description = Запускает самонаводящийся неподвижный стержень прямо в них.

admin-smite-homing-rod-slow-description = Запускает прямо в них медленно движущийся самонаводящийся неподвижный стержень.
