...
chat-manager-admin-ooc-chat-enabled-message = Админ-OOC включён.
chat-manager-admin-ooc-chat-disabled-message = Админ-OOC отключён.
...
chat-manager-rate-limit-admin-announcement = Предупреждение о лимите сообщений: { $player }
...
chat-manager-send-hook-admin-wrap-message = АДМИНИСТРАТОР: [bold](D){$senderName}:[/bold] {$message}

chat-speech-verb-vulpkanin-1 = сырцы

chat-speech-verb-vulpkanin-2 = лает

chat-speech-verb-vulpkanin-3 = рублей
...
chat-speech-verb-wawa-2 = государства
