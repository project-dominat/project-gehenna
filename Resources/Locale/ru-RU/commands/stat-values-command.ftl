...
stat-melee-values = Урон от оружия ближнего боя

stat-melee-id = идентификатор

stat-melee-base-damage = Базовый урон

stat-melee-wield-damage = Нанесенный урон

stat-melee-attack-rate = Скорость атаки

stat-melee-dps = ДПС

stat-melee-structural-damage = Повреждение конструкции

stat-melee-structural-wield-damage = Повреждение конструкции
