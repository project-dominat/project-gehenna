...
contraband-examine-text-Highly-Illegal =
    { $type ->
        *[item] [color=crimson]Этот предмет является строго незаконной контрабандой![/color]
        [reagent] [color=crimson]Этот реагент является в высшей степени незаконной контрабандой![/color]
    }
