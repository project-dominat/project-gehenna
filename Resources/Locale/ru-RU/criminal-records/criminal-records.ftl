...
criminal-records-status-eliminated = Устранено

criminal-records-console-hostile = {$name} ({$job}) был помечен {$officer} как враждебный для: {$reason}.

criminal-records-console-not-hostile = {$name} ({$job}) больше не помечается {$officer} как враждебный.

criminal-records-console-eliminated = {$name} ({$job}) был помечен как исключенный {$officer}.

criminal-records-console-not-eliminated = {$name} ({$job}) больше не помечается как исключенный {$officer}.

criminal-records-job-filter = Работа

criminal-records-species-filter = Виды
