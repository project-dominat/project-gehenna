...
delivery-priority-delivered-examine = Это [color=orange]приоритет {$type}[/color]. Его доставили вовремя.

delivery-bomb-examine = Это бомба [color=purple] {$type}[/color]. О, нет.

delivery-bomb-primed-examine = Это бомба [color=purple] {$type}[/color]. Чтение этого — плохая трата времени.
