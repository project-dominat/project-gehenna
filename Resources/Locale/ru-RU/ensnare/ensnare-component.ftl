...
ensnare-component-try-free-complete-other = Вы успешно освободили { $user } из { $ensnare }!


ensnare-component-try-free-fail-other = Вам не удалось освободить { $user } из { $ensnare }!
