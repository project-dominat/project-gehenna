...
nukeops-disk-location-title = Окончательное расположение Диска:

nukeops-disk-carried-by = {" "}переносят [color=White]{$name}[/color], [color=orange]{$job}[/color], {$location} { $user ->
    [unknown] { "" }
