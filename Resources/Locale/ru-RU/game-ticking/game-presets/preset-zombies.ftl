...
zombieteors-description = Нежить была выпущена на станцию на фоне катастрофического метеоритного дождя! Работайте вместе с вашим экипажем и делайте все возможное, чтобы выжить!
