...
ghost-role-information-emotional-support-scurret-name = Эмоциональная поддержка

ghost-role-information-emotional-support-scurret-description = Поддержите команду, будьте очаровательны, много говорите «ва».
