...
lathe-menu-silo-linked-message = Силос связан

lathe-menu-delete-fabricating-tooltip = Отменить печать текущего элемента.

lathe-menu-delete-item-tooltip = Отмените печать этого пакета.

lathe-menu-move-up-tooltip = Переместите этот пакет вперед в очереди.

lathe-menu-move-down-tooltip = Переместите этот пакет обратно в очередь.
