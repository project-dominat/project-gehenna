...
cmd-mapping-try-grid = Не удалось загрузить файл как карту. Попытка загрузить файл в виде сетки...

cmd-mapping-success-load-grid = Загрузил неинициализированную сетку из файла {$path} на новую карту с идентификатором {$mapId}.
