...
marking-LizardTailAquatic-tail_aquatic = Хвост Ящерицы (Водный)

marking-LizardTailAquatic = Хвост Ящерицы (Водный)

marking-LizardChestFin-body_fin = Ящерица Плавник

marking-LizardChestFin = Ящерица Плавник

marking-LizardSnoutVisageSharp = Ящерица (Острый)

marking-LizardSnoutVisageSharp-visage_sharp = Ящерица (Острый)

marking-LizardSnoutVisageRound = Ящерица (круглая)

marking-LizardSnoutVisageRound-visage_round = Ящерица (круглая)
