...
marking-TattooEyeshadowUpper-tattoo_eyeshadow_upper = Тени для век (Верхний)

marking-TattooEyeshadowUpper = Тени для век (Верхний)
...
marking-TattooVoxTailRing-tattoo_vox_tail_ring = Хвостовое кольцо

marking-TattooVoxTailRing = Хвостовое кольцо
