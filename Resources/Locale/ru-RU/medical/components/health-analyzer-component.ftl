...
health-analyzer-window-entity-damage-total-text = Суммарный урон:

health-analyzer-window-damage-group-text = { $damageGroup }: { $amount }
health-analyzer-window-damage-type-text = { $damageType }: { $amount }

health-analyzer-window-entity-unrevivable-text = [color=yellow]Обнаружен уникальный состав тела! Пациента невозможно реанимировать стандартными методами![/color]
