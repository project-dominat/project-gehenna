cmd-rmobjective-desc = Удаляет цель из разума игрока.
...
cmd-rmobjective-failed = Не удалось удалить цель. Возможно, индекс вне допустимого диапазона? Проверьте lsobjectives!


cmd-rmobjective-invalid-index = Не удалось проанализировать индекс { $index } как целое число.


cmd-rmobjective-invalid-objective-info = НЕДЕЙСТВИТЕЛЬНО
