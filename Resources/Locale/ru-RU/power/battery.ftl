...
battery-menu-discharge-header = Цепь разрядки


battery-menu-storage-header = Накопители
...
battery-menu-eta-full = Время до полной:


battery-menu-eta-empty = Время до пустой:
