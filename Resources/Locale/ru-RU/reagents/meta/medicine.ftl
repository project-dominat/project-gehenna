...
reagent-name-arcryox = акриоксарин
...
reagent-desc-heparin = Обычно используется в качестве антикоагулянтного препарата. Вызывает затруднение образования тромбов в крови. При передозировке может вызвать внутреннее кровотечение.
