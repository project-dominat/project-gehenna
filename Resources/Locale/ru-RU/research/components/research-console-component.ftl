...
research-console-menu-title = Консоль НИОКР
research-console-menu-research-points-text = Исследования: [color=orchid]{ $points }[/color]
...
research-console-unlocked-text = Разблокированные технологии
...
research-console-unlock-technology-radio-broadcast = Разблокирована [bold]{ $technology }[/bold] за [bold]{ $amount }[/bold] очков исследований — [bold]{ $approver }[/bold].
