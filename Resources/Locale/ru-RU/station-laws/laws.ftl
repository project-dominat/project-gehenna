...
law-emag-custom = Только { $name } и лица, им указанные, являются { $title }.
...
law-crewsimov-name = Крюсимов

law-corporate-name = Корпоративный

law-ntdefault-name = NT по умолчанию
