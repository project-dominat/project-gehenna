...
uplink-mosin-ammo-name = Коробка патронов (7,62R)
...
uplink-l6-saw-bundle-name = Набор "L6 Mini-Saw"


uplink-l6-saw-bundle-desc = Ещё больше дакки: культовый лёгкий пулемёт L6 в комплекте с 3 коробами патронов по 150 патронов каждый. Штурмовая версия, что совершенно не сковывает движение, ценой точности.
...
uplink-estoc-ammo-name = Винтовочный магазин (винтовка .20)

uplink-estoc-ammo-desc = Винтовочный магазин на 25 патронов. Совместим с Estoc DMR.

uplink-syndicate-id-card-name = Удостоверение личности синдиката

uplink-syndicate-id-card-desc = Удостоверение личности Синдиката с доступом к Синдикату. Вряд ли будет полезен сам по себе, но отлично сочетается с измененной конфигурацией дверей. Не имеет функции копирования доступа.

uplink-grenade-launcher-bundle-name = Пакет «Китай-Озеро»

uplink-grenade-launcher-bundle-desc = Старый гранатомет «Китай-Озеро» в комплекте с 11 выстрелами разной поражающей способности.

uplink-starter-kit-name = Базовый оперативный пакет
...
uplink-saw-advanced-name = Усовершенствованная циркулярная пила

uplink-saw-advanced-desc = Новейший хирургический инструмент, предназначенный для разрезания плоти и костей.

# Armor

uplink-clothing-chameleon-thieving-gloves-name = Воровские перчатки-хамелеоны

uplink-clothing-chameleon-thieving-gloves-desc = Осторожно воруйте из карманов и совершенствуйте свою технику воровства с помощью этих модных новых перчаток. Они могут изменить внешний вид, чтобы соответствовать любой паре перчаток!

uplink-travel-camera-name = Камера для путешествий

uplink-travel-camera-desc = Поразите людей своими навыками фотографии и удобной легальной вспышкой. Делает вас похожим на туриста.

uplink-acolyte-armor-name = Доспехи послушника

uplink-acolyte-armor-desc = Незаменимая вещь для любого уважающего себя лидера культа. Зловещий на вид доспех, сделанный из костей и удивительно устойчивый к повреждениям.

uplink-briefcase-gun-name = Портфель Пистолет

uplink-briefcase-gun-desc = Невзрачный портфель, внутри которого установлен очень компактный С-20К. Будьте осторожны, не держите ручку слишком туго!

uplink-hijack-beacon-name = Угнать маяк

uplink-hijack-beacon-desc = Маяк для взлома под брендом синдиката, предназначенный для обхода брандмауэров автоматизированных торговых станций бренда Nanotrasen. Для их работы требуется 200 секунд, и торговые станции сообщат, что их взломали, поэтому подготовьтесь соответствующим образом.
