...
tips-dataset-138 = Если вы хотите, чтобы заключенный не сбежал из камеры сразу после снятия наручников, включите боевой режим во время снятия наручников — это оттолкнет заключенного вниз.

tips-dataset-139 = Обязательно очищайте нелегальные имплантаты мылом после их использования! Детективы могут сканировать бывшие в употреблении имплантаты на предмет компрометирующих ДНК, но только не в том случае, если они были полностью стерты.
