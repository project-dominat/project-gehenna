...
voice-mask-name-change-accent-toggle = Блочный акцент

voice-mask-popup-toggle = Переключена голосовая маска.

voice-mask-popup-accent-toggle = Переключенный акцент.
